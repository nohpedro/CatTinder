    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/preferences").hasAnyRole("ADMIN", "USER")
                .requestMatchers(HttpMethod.GET, "/api/v1/preferences/**").hasAnyRole("ADMIN", "USER")
                
                // Solo ADMIN puede actualizar/eliminar
                .requestMatchers(HttpMethod.PUT, "/api/v1/preferences/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/preferences/**").hasRole("ADMIN")
